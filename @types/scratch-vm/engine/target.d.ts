...
declare class Target extends EventEmitter {
     ...
     */
    lookupVariableByNameAndType(name: string, type: string, skipStage: any): Variable | null;
    /**
    ...
    * @return {!Varible} Variable object representing the found/created list.
     */
    lookupOrCreateList(id: string, name: string): any;
    /**
     ...
     */
    getAllVariableNamesInScopeByType(type: string, skipStage: any): Array<string>;
    /**
