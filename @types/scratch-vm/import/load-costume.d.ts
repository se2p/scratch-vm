 ...
 */
export function loadCostume(md5ext: string, costume: object, runtime: any, optVersion: any): Promise<any> | null;
/**
 ...
 * @returns {?Promise} - a promise which will resolve after skinId is set, or null on error.
 */
export function loadCostumeFromAsset(costume: object, runtime: any, optVersion: any): Promise<any> | null;
